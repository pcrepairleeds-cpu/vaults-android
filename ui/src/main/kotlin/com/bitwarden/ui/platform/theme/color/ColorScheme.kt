...
private data object PrimitiveColors {
    ...
    val blue050: Color = Color(color = 0xFFE9F4F4)
    val blue100: Color = Color(color = 0xFFCFE9E9)
    val blue150: Color = Color(color = 0xFFBCE0E0)
    val blue200: Color = Color(color = 0xFFA3D6D6)
    val blue300: Color = Color(color = 0xFF6EC0C0)
    val blue400: Color = Color(color = 0xFF34A3A3)
    val blue500: Color = Color(color = 0xFF058181)
    val blue600: Color = Color(color = 0xFF046B6B)
    val blue700: Color = Color(color = 0xFF023A3A)
